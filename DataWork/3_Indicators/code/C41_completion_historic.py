# -------------------------------------------------------------------------
# C41_completion_historic.py
# -------------------------------------------------------------------------
# Author: Vitor
# Last update: 2026-06-27
#
# Description:
#   Serie historica: % de jovens 14-21 que concluiram EM (VD3004 >= 5)
#   por idade, ano de observacao e grupo de renda. Anos: 2015, 2017,
#   2019, 2021, 2023, 2025.
#
# Outputs:
#   ../output/C41_completion_historic.csv
# -------------------------------------------------------------------------
...
LINHA_EXTREMA = 230
SM = {2015: 788, 2017: 937, 2019: 998,
      2021: 1100, 2023: 1320, 2025: 1518}
...
agg.to_csv(OUT_DIR / "C41_completion_historic.csv", index=False)
print(f"\nSaved C41_completion_historic.csv ({len(agg)} rows)")
