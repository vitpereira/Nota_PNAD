...
A queda abrupta coincide com a substituição da coleta
presencial CAPI (\emph{Computer-Assisted Personal
Interviewing}) pela coleta telefônica CATI
(\emph{Computer-Assisted Telephone Interviewing}) adotada
pelo IBGE em meados de março de 2020 como resposta à
pandemia. Sob CATI, a entrevista é mais rápida, a
verificação visual de documentos escolares é impossível, e
a probabilidade de o respondente confirmar a declaração da
visita anterior, sem reavaliação ativa, é
substancialmente maior. Esse mecanismo é coerente com
todos os fatos observados. A repetência longitudinal
inflaciona-se porque o valor de \texttt{V3006} declarado
em $t+1$ tende a herdar o de $t$. A idade média transversal
na série permanece estável porque o número absoluto de
alunos sob carregamento de resposta é pequeno em relação
ao total declarado em cada série a cada ano. A evasão
permanece consistente entre PNADC e INEP porque
\texttt{V3002}, sendo binária e mais robusta a entrevista
abreviada, sofre carregamento menor. A recuperação parcial
em 2024 acompanha a reintrodução gradual de coleta
presencial na PNADC.

Essa hipótese é única no sentido de explicar simultaneamente
três fatos discordantes: estabilidade do questionário formal,
estabilidade da idade média na série, e inflação da
repetência longitudinal. Hipóteses alternativas que
permanecem em consideração, ainda que menos parcimoniosas,
incluem a corrupção do \emph{linkage} entre visitas e o
atrito diferencial por progressão. O \emph{linkage}, testado
diretamente por consistência de sexo entre $t$ e $t+1$,
mantém-se acima de noventa e nove por cento em todos os anos
do período pós-pandêmico, dentro do mesmo patamar
pré-pandêmico, o que sugere que a probabilidade de
indivíduos serem trocados na ligação entre visitas é baixa.
A confirmação cabal da hipótese de carregamento sob CATI
exigiria acesso aos protocolos internos de coleta do IBGE
ano a ano, exercício fora do escopo desta nota.
