...
Antes de listar as hipóteses substantivas para a anomalia,
verificamos sistematicamente se houve alguma alteração na
estrutura ou codificação do questionário da PNADC sobre
educação a partir de 2022 que pudesse explicar artificialmente
o aumento da repetência reportada. A consulta ao dicionário
oficial das variáveis da PNADC, em sua versão de outubro de
2022, e a comparação direta das distribuições de cada
variável-chave entre 2017 e 2024 confirmam que as quatro
...
mantiveram exatamente os mesmos códigos e categorias em todos
os trimestres do período. As variáveis \texttt{V3006A} (etapa
do EF) e \texttt{V3013B} (concluiu os anos iniciais), que
poderiam ter sido introduzidas em algum trimestre recente, na
realidade foram adicionadas no primeiro trimestre de 2018,
muito antes da pandemia, e não houve qualquer alteração no
\emph{layout} do dicionário entre 2019 e 2024 que afetasse a
classificação de série. A possibilidade de artefato gerado por
mudança na estrutura do questionário pode portanto ser
descartada como explicação para a anomalia pós-pandêmica.

Restam três hipóteses substantivas. A primeira é que a
confusão familiar gerada por 2020 e 2021 persistiu nos anos
seguintes, com famílias continuando a reportar séries não
atualizadas em virtude do calendário letivo ainda em
transição em diversas redes. A segunda é que os sistemas
educacionais, após o período de aprovação automática,
voltaram a aplicar a reprovação com rigor acumulado,
possivelmente movendo formalmente alunos para níveis abaixo
daqueles em que tinham sido provisoriamente classificados
durante a pandemia, e que esse movimento está sendo capturado
pela PNADC como repetência. A terceira é que o aprendizado
efetivamente perdido durante a pandemia está agora se
traduzindo em maior reprovação real nas escolas, com
sistemas avaliando o desempenho dos alunos com critérios
mais rigorosos do que durante o auge da pandemia. A
evidência atual não permite distinguir entre essas
hipóteses, e provavelmente todas operam em algum grau. Uma
quarta hipótese, residual mas não descartável, é que o IBGE
tenha alterado as instruções operacionais de coleta nos
anos pós-COVID, em particular após o retorno gradual das
entrevistas presenciais em 2022, sem alteração do
dicionário formal, mas com efeito sobre a forma como o
entrevistador formula a pergunta sobre série corrente.
Verificar essa possibilidade exigiria acesso aos manuais
do entrevistador da PNADC ano a ano, exercício que está
