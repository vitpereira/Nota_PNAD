...
Uma terceira hipótese substantiva, também descartada pelos
dados, é a migração para a Educação de Jovens e Adultos. Em
princípio, poder-se-ia conjecturar que alunos do ensino
médio regular que perderam tempo durante a pandemia teriam
buscado a EJA como rota de recuperação acelerada, gerando
queda da promoção e aumento da repetência reportadas no
sistema regular. A construção do indicador é incompatível
com esse mecanismo. A repetência longitudinal exige que o
aluno esteja em curso regular tanto em $t$ quanto em $t+1$,
ao passo que migração para EJA é registrada como categoria
separada \texttt{flag\_migracao\_eja}, mutuamente exclusiva
com repetência. Empiricamente, a taxa de migração para EJA
no EM é virtualmente constante e levemente declinante ao
longo do período, em torno de zero vírgula seis por cento
em 2012, zero vírgula dois por cento em 2019, e zero a zero
vírgula um por cento em 2022 e 2023, sem qualquer salto
pós-pandêmico. A distribuição transversal de matrículas
entre adolescentes de quinze a dezessete anos confirma o
ponto. A proporção em EJA EM cai de zero vírgula quarenta e
nove por cento em 2017 para zero vírgula dezessete por
cento em 2023, ao passo que a proporção em EM regular sobe
de sessenta e nove para setenta e seis por cento no mesmo
período. A tendência é oposta à hipótese.
