...
A hipótese remanescente compatível com os dois fatos é, em
suma, um artefato gerado na construção do painel
longitudinal e não na declaração de cada observação
isoladamente. Três mecanismos específicos são candidatos.
O primeiro é a corrupção do \emph{linkage} entre visitas,
isto é, indivíduos diferentes do mesmo domicílio sendo
encaixados como se fossem o mesmo aluno entre $t$ e $t+1$.
A regra de \emph{matching} adotada admite 80\% de
consistência entre sexo e idade, e mudanças na composição
domiciliar pós-COVID, como retornos temporários, hóspedes
e rearranjos familiares, podem ter ampliado o ruído de
identificação dentro dessa tolerância. O segundo é o atrito
diferencial por progressão. Se alunos que avançam para o
ensino superior, mudam de cidade ou abandonam o domicílio
parental são desproporcionalmente removidos do painel pelo
mecanismo de atrito, o painel \emph{sobrevivente} sobre-
representa quem permaneceu na mesma série, gerando
inflação aparente de repetência. Esse efeito é compatível
com idade média estável na série, porque a seção
transversal continua observando todos os alunos
matriculados, inclusive os que progrediram em outros
domicílios. O terceiro é a mudança da composição amostral
das rotações pós-2020. O esquema rotativo da PNADC foi
afetado pela suspensão temporária de coleta presencial em
2020, e a recomposição posterior das rotações pode ter
introduzido viés sistemático na sub-amostra dos painéis
longitudinais 2021-2024 em relação à seção transversal
correspondente. Distinguir essas três hipóteses exigiria
acesso ao código de linkage do IBGE e à composição
detalhada das rotações pós-COVID, exercício fora do escopo
desta nota.
